...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "Applozic/Applozic/Images.xcassets/Applozic_img_store/broadcast.imageset/Contents.json"
  install_resource "Applozic/Applozic/Images.xcassets/Applozic_img_store/broadcast_group.imageset/Contents.json"
  ...
  install_resource "Applozic/Applozic/Images.xcassets/Applozic_img_store/phone_book.imageset/Contents.json"
